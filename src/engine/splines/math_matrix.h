...
{
	return mat3_t( mat[0].x * a, mat[0].y * a, mat[0].z * a, mat[1].x * a, mat[1].y * a, mat[1].z * a, mat[2].x * a, mat[2].y * a, mat[2].z * a );
}

ID_INLINE mat3_t mat3_t::operator+( mat3_t const& a ) const
{
	return mat3_t( mat[0].x + a[0].x, mat[0].y + a[0].y, mat[0].z + a[0].z, mat[1].x + a[1].x, mat[1].y + a[1].y, mat[1].z + a[1].z, mat[2].x + a[2].x, mat[2].y + a[2].y, mat[2].z + a[2].z );
}
...
{
	return mat3_t( b[0].x * a, b[0].y * a, b[0].z * a, b[1].x * a, b[1].y * a, b[1].z * a, b[2].x * a, b[2].y * a, b[2].z * a );
}
...
ID_INLINE void mat3_t::OrthoNormalize()
{
	mat[0].Normalize();
...
ID_INLINE void mat3_t::Identity()
{
	mat[0].x = 1.f;
	mat[0].y = 0.f;
	mat[0].z = 0.f;
