 ...
 */
{
	 ...
	 */
	static const unsigned int std_luminance_quant_tbl[DCTSIZE2]	  = { 16,
		  11,
		  12,
		  14,
		  12,
		  ...
		  103,
		  99 };
	static const unsigned int std_chrominance_quant_tbl[DCTSIZE2] = { 17,
		18,
		18,
		24,
		21,
...
/* IMPORTANT: these are only valid for 8-bit data precision! */
{
	...
	static const UINT8 val_ac_luminance[]	 = { 0x01,
		   0x02,
		   0x03,
		   0x00,
		   0x04,
	...
	static const UINT8 val_ac_chrominance[]	   = { 0x00,
		   0x01,
		   0x02,
		   0x03,
		   0x11,
