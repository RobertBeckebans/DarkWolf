...
static FT_Error ft_raster1_render( FT_Renderer render, FT_GlyphSlot slot, FT_UInt mode, FT_Vector* origin )
{
	FT_Error		 error;
	FT_Outline*		 outline;
	FT_BBox			 cbox;
...
const FT_Renderer_Class ft_raster1_renderer_class = { { ft_module_renderer,
...
const FT_Renderer_Class ft_raster5_renderer_class = { { ft_module_renderer,
														  sizeof( FT_RendererRec ),
