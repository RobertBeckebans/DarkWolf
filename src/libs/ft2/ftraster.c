...
static void ft_black_init( TRaster_Instance* raster )
{
	...
	for( n = 0; n < 256; n++ ) {
		...
		c = ( ( c << 6 ) & 0x3000 ) | ( ( c << 4 ) & 0x0300 ) | ( ( c << 2 ) & 0x0030 ) | ( c & 0x0003 );
...
static void ft_black_reset( TRaster_Instance* raster, const char* pool_base, long pool_size )
{
...
FT_Raster_Funcs ft_standard_raster = { ft_glyph_format_outline,
