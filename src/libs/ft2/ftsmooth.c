...
static FT_Error ft_smooth_render( FT_Renderer render, FT_GlyphSlot slot, FT_UInt mode, FT_Vector* origin )
{
	FT_Error		 error;
	FT_Outline*		 outline;
	FT_BBox			 cbox;
...
const FT_Renderer_Class ft_smooth_renderer_class = { { ft_module_renderer,
