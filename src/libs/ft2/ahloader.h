...
LOCAL_DEF
FT_Error AH_GlyphLoader_Check_Points( AH_GlyphLoader* loader, FT_UInt n_points, FT_UInt n_contours );
...
LOCAL_DEF
FT_Error AH_GlyphLoader_Copy_Points( AH_GlyphLoader* target, FT_GlyphLoader* source );
