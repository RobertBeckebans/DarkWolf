...
/*                                                                       */
BASE_FUNC( FT_Error ) FT_List_Iterate( FT_List list, FT_List_Iterator iterator, void* user )
{
...
/*                                                                       */
BASE_FUNC( void ) FT_List_Finalize( FT_List list, FT_List_Destructor destroy, FT_Memory memory, void* user )
{
	FT_ListNode cur;
