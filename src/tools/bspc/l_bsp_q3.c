...
void Q3_SwapBSPFile()
{
	...
	for( i = 0; i < q3_numShaders; i++ ) {
		...
		q3_dshaders[i].contentFlags &= ( CONTENTS_SOLID | CONTENTS_WINDOW | CONTENTS_LAVA | CONTENTS_SLIME | CONTENTS_WATER | CONTENTS_MIST | CONTENTS_AREAPORTAL | CONTENTS_PLAYERCLIP |
										 CONTENTS_MONSTERCLIP | CONTENTS_ORIGIN | CONTENTS_DETAIL );
	}
