...
// Changes Globals:		-
//============================================================================
int PC_ExpandBuiltinDefine( source_t* source, define_t* define, token_t** firsttoken, token_t** lasttoken )
{
	token_t		  token;
...
// Changes Globals:		-
//============================================================================
int PC_ExpandDefine( source_t* source, define_t* define, token_t** firsttoken, token_t** lasttoken )
{
