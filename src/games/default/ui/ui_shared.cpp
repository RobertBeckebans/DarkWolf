...
static bind_t	 g_bindings[] = { { "+scores", -1, -1, -1, -1 },
	   { "+speed", K_SHIFT, -1, -1, -1 },
...
void Item_ValidateTypeData( itemDef_t* item )
{
	...
	} else if( item->type == ITEM_TYPE_EDITFIELD || item->type == ITEM_TYPE_NUMERICFIELD || item->type == ITEM_TYPE_VALIDFILEFIELD || item->type == ITEM_TYPE_YESNO || item->type == ITEM_TYPE_BIND ||
