...
void CG_DrawChar( int x, int y, int width, int height, int ch )
{
	...
	sys->R_DrawStretchPic( ax, ay, aw, ah, fcol, frow, fcol + size, frow + size, cgs.media.charsetShader );
}
...
void CG_DrawChar2( int x, int y, int width, int height, int ch )
{
	...
	sys->R_DrawStretchPic( ax, ay, aw, ah, fcol, frow, fcol + size, frow + size, cgs.media.menucharsetShader );
}
