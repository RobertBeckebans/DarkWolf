	...
	int						  duration )
{
	...
	numFragments =
		sys->CM_MarkFragments( ( int )orientation, ( const vec3_t* )originalPoints, projection, MAX_MARK_POINTS, ( float* )&markPoints[0], MAX_MARK_FRAGMENTS * multMaxFragments, markFragments );
