...
static void PM_SetMovementDir()
{
	...
	if( ( pm->cmd.forwardmove || pm->cmd.rightmove ) && ( pm->ps->groundEntityNum != ENTITYNUM_NONE ) && ( speed = VectorLength( moved ) ) &&
...
static void PM_FinishWeaponReload()
{
