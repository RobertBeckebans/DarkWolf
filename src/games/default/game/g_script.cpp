...
g_script_stack_action_t gScriptActions[] = { { "gotomarker", G_ScriptAction_GotoMarker },
...
g_script_event_define_t gScriptEvents[] = { { "spawn", NULL }, // called as each character is spawned into the game
