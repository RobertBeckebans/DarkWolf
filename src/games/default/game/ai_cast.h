...
//
// predict events
typedef enum { PREDICTSTOP_NONE, PREDICTSTOP_HITENT, PREDICTSTOP_HITCLIENT } predictStop_t;
//
typedef enum { AITEAM_NAZI, AITEAM_ALLIES, AITEAM_MONSTER, AITEAM_SPARE1, AITEAM_SPARE2, AITEAM_SPARE3, AITEAM_SPARE4, AITEAM_NEUTRAL } AITeam_t;
//
...
//
typedef enum { MSTYPE_NONE, MSTYPE_TEMPORARY, MSTYPE_PERMANENT } movestateType_t;
//
//
...
void				 AICast_Heinrich_SoundPrecache();
//
// ai_cast_fight.c
